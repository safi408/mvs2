...
<div class="container py-5">
  <div class="card shadow-sm border-0 rounded-4 p-4">
    <h4 class="fw-bold mb-4 text-primary">
      <i class="bi bi-diagram-3 me-2"></i>Add New Child Category
    </h4>
    ...
    <form action="{{route('childcategory.store')}}" method="POST">
      ...
      <div class="row g-3">
        ...
        <div class="col-md-12">
          ...
          <div class="input-group">
            ...
            <input type="text" name="name" class="form-control" placeholder="Enter Child Category name">
          </div>
          @error('name')
            <div class="text-danger small"><i class="bi bi-exclamation-circle me-1"></i>{{ $message }}</div>
          @enderror
      ...
      <div class="mt-4 text-end">
        <button type="submit" class="btn btn-primary px-4 rounded-pill fw-bold">
          <i class="bi bi-save2-fill me-1"></i> Save Child Category
        </button>
      </div>
    </form>
  </div>
