    ...
    <div class="col-md-12">
      ...
      <div class="card shadow-lg border-0 rounded-3">
        <div class="card-header bg-primary text-white d-flex align-items-center">
          ...
          <h4 class="mb-0">Add Vendor Store</h4>
        </div>
        ...
        <div class="card-body">
          <form action="{{route('vendor.store')}}" method="POST" enctype="multipart/form-data">
              ...
              <div class="col-md-4">
                <div class="p-3 border rounded d-flex align-items-center">
                  ...
                  <div class="flex-grow-1">
                    ...
                    <input type="text" class="form-control" id="store_slug" name="store_slug" placeholder="auto-generated or enter manually">
                     @error('store_slug')
                         <span class="text-danger">{{$message}}</span>
                     @enderror
                  </div>
              ...
              <div class="col-md-6">
                <div class="p-3 border rounded d-flex align-items-center">
                  ...
                  <div class="flex-grow-1">
                    ...
                    <input type="number" step="0.01" class="form-control" id="commission_rate" name="commission_rate" placeholder="e.g. 10.00">
                  </div>
                </div>
              </div>
              ...
              <div class="col-md-12">
                <div class="p-2 border rounded d-flex align-items-start">
                  ...
                  <div class="flex-grow-1">
                    ...
                    <textarea class="form-control" id="summernote" name="store_description" rows="3" placeholder="Write about your store..."></textarea>
                  </div>
                </div>
              </div>
            ...
            <!-- Submit -->
            <div class="mt-2 d-flex justify-content-end mt-2">
              <button type="submit" class="btn btn-primary btn-md p-2">
