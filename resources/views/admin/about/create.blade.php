...
<div class="container py-5">
  <div class="card shadow-sm p-4 rounded-4">
    ...
    {{--  Add Brand Form --}}
    <form action="{{route('admin.brand.store')}}" method="POST" enctype="multipart/form-data" class="mb-4">
      @csrf
      <div class="row g-3 align-items-end">
        ...
        <div class="col-md-4">
          <button class="btn btn-primary px-4 fw-bold rounded-pill">Add Brand</button>
        </div>
      </div>
    </form>
