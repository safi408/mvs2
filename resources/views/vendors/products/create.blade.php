...
@endif
            <form action="{{ route('vendor.products.store') }}" method="POST" enctype="multipart/form-data" id="productForm">
                ...
                <div class="row g-3 mb-4">
                    ...
                    <div class="col-md-4">
                        <label class="form-label fw-semibold"><i class="bi bi-diagram-2 me-1 text-success"></i> Childcategory</label>
                ...
                <div class="row g-3 mb-4">
                    ...
                    <div class="col-md-3">
                        <label class="form-label fw-semibold"><i class="bi bi-rulers me-1 text-secondary"></i> Sizes</label>
                        <div class="d-flex gap-3 mt-2">
                            <div><input type="checkbox" name="sizes[]" value="S"> S</div>
                            <div><input type="checkbox" name="sizes[]" value="M"> M</div>
                            <div><input type="checkbox" name="sizes[]" value="L"> L</div>
                            <div><input type="checkbox" name="sizes[]" value="XL"> XL</div>
                        </div>
                    </div>
...
$(document).ready(function() {
        ...
        div.innerHTML = `
            <div class="d-flex justify-content-between align-items-center mb-3">
                <div class="d-flex align-items-center gap-3 flex-grow-1">
                    ...
                    <input type="text" name="colors[${colorIndex}][name]" placeholder="Color Name" class="form-control rounded-3">
    ...
    <input type="hidden" name="colors[${colorIndex}][sizes]" class="sizes-hidden-input">
</div>
                <div class="col-md-4">
