...
<div class="row">
    ...
    <div class="col-lg-3 col-6">
        <div class="small-box text-bg-info">
            ...
            <a href="{{route('category.manage')}}" class="small-box-footer text-decoration-none">
    ...
    <div class="col-lg-3 col-6">
        <div class="small-box text-bg-secondary">
            ...
            <i class="small-box-icon bi bi-diagram-3-fill"></i>
             <a href="{{ route('subcategory.manage') }}" class="small-box-footer text-decoration-none">
    Manage Sub Categories <i class="bi bi-arrow-right"></i>
</a>
                ...
                <div class="col-lg-3 col-6">
                    <div class="small-box text-bg-primary">
                        ...
                        <a href="{{ route('admin.show.product') }}" class="small-box-footer text-decoration-none">
    Manage Products <i class="bi bi-arrow-right"></i>
                ...
                <div class="col-lg-3 col-6">
                    <div class="small-box text-bg-warning">
                        ...
                        <a href="{{ route('user.manage') }}" class="small-box-footer text-decoration-none">
...
<div class="col-lg-3 col-6">
    <div class="small-box text-bg-success">
        ...
        <i class="small-box-icon bi bi-shop"></i>
         <a href="{{ route('vendor.list') }}" class="small-box-footer text-decoration-none">
    View Vendors <i class="bi bi-arrow-right"></i>
</a>
